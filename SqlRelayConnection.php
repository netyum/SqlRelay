 ...
 * @since 1.0
 */
class SqlRelayConnection extends CDbConnection
{
	/**
	...
	public function getSchema()
	{
		...
		{
			//return $this->_schema=Yii::createComponent('SqlRelayOciSchema', $this);
			return $this->_schema=Yii::createComponent('COciSchema', $this);
		}
	}
